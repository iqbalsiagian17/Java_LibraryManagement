...
public class DashboardController implements Initializable {
    ...
    @FXML
    private AnchorPane availabeBooks_form;

    @FXML
    private Button availableBooks_btn;

    @FXML
    private Label availableBooks_code;
    ...
    @FXML
    private TableColumn<availableBooks, String> col_ab_bookCode;
    ...
    @FXML
    private TableColumn<availableBooks, String> col_ab_publishDate;
    ...
    @FXML
    private TableColumn<returnBook, String> return_BookCode;
    ...
    public ObservableList<availableBooks> dataList() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                aBooks = new availableBooks(result.getString("bookTitle"),result.getString("bookCode"),
...
String sql = "INSERT INTO take VALUES (?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            if (take_FirstName.getText().isEmpty()
                ...
                prepare = connect.prepareStatement(sql);
                prepare.setString(1, take_nim.getText());
                ...
                prepare.setString(6, take_codeLabel.getText());
                prepare.setString(7, take_authorLabel.getText());
                prepare.setString(8, take_genreLabel.getText());

                prepare.setString(9, getData.path);
                prepare.setDate(10, sqlDate);

                String check = "Not Return";
                prepare.setString(11, check); // Error di sini, karena indeks ke-10
       ...
       public ObservableList<returnBook> returnBook() {
        ...
        String sql = "SELECT * FROM take WHERE checkReturn = '" + check + "' and nim = '"
                + getData.nim + "'";
        ...
        try {
            ...
            while (result.next()) {
                ...
                rBook = new returnBook(result.getString("bookTitle"),result.getString("bookCode"), result.getString("author"),
    ...
    public void showBookReturn() {
        ...
        return_BookCode.setCellValueFactory(new PropertyValueFactory<>("code"));
        ...
        try {
            ...
            if (take_BookTitle.getText().isEmpty()) {
                ...
                while (result.next()) {
                    ...
                    take_codeLabel.setText(result.getString("bookCode"));
 ...
 //    SAVED BOOKS
    public ObservableList<saveBook> savedBooksData() {
        ...
        String sql = "SELECT * FROM save WHERE nim = '"+ getData.nim +"'";
...
// THANKS! : ) 
    ...
    public void saveBooks() {
        ...
        try {
            ...
            if (availableBooks_title.getText().isEmpty()) {
                ...
                prepare = connect.prepareStatement(sql);
                prepare.setString(1, getData.nim);
 ...
 public void unsaveBooks() {
    ...
    public void nimLabel() {
        take_nim.setText(getData.nim);
    }

    public void clearTakeData() {

        take_BookTitle.setText("");
        take_codeLabel.setText("");
    ...
    public void showAvailableBooks(){
       ...
       listBook = dataList();
        ...
        col_ab_bookCode.setCellValueFactory(new PropertyValueFactory<>("code"));
        ...
        col_ab_publishDate.setCellValueFactory(new PropertyValueFactory<>("date"));
...
//      NOTE! DON'T FORGET THE "file:"
        ...
        image = new Image(uri, 173, 198, false, true);
        ...
        getData.savedAuthor = bookData.getCode();
    ...
    if (event.getSource() == availableBooks_btn) {
            ...
            savedBook_form.setVisible(false);
            returnBook_form.setVisible(false);
            availabeBooks_form.setVisible(true);
            ...
            savedBook_form.setVisible(false);
            returnBook_form.setVisible(false);
            availabeBooks_form.setVisible(false);
            ...
            returnBook_form.setStyle("-fx-background-color:linear-gradient(to bottom right, #46589a, #4278a7);");
            availableBooks_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #344275, #3a6389);");
            issueBooks_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #344275, #3a6389);");
            savedBooks_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #344275, #3a6389);");
    ...
    if (uri != null && !uri.isEmpty()) {
        uri = uri.replace("\\", "\\\\");
        String sql = "UPDATE student SET image = '" + uri + "' WHERE nim = '" + getData.nim + "'";
